<div class="content-wrapper">
  ...
  <section class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="font-weight-bold">Form Edit Warna</h1>
        </div>
      </div>
    </div><!-- /.container-fluid -->
  </section>
            ...
            <form action="<?= BASEURL ?>/warna/update" method="post">
              ...
              <div class="card-body">
                <div class="form-group">
                  ...
                  <input type="text" name="kode" id="kode" value="<?= $data['warna']['KODE_WARNA'] ?>" readonly
              ...
              <div class="card-footer">
                ...
                <a href="<?= BASEURL ?>/warna" class="btn btn-info float-md-right">Kembali</a>
              </div>
            </form>
          </div>
          <!-- /.card -->
